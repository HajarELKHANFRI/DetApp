...
import com.example.whoami.cnn.CNNExtractorService;
import com.example.whoami.cnn.impl.CNNExtractorServiceImpl;
...
public class GeneralActivity extends CameraActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
...
//        Imgproc.findContours(frame,contours,new Mat(),Imgproc.RETR_FLOODFILL, Imgproc.CHAIN_APPROX_SIMPLE);
//        for (int i = 0; i < contours.size(); i++) {
//            Imgproc.drawContours(frame, contours, i, new Scalar(255, 255, 255), -1);
//        }
